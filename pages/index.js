...
import { Flex, Link, Box, Button, Icon, Text, Spacer } from "@chakra-ui/react";
...
// body.classList.toggle("dark_row");

// var header = document.querySelector("header");
// header.classList.toggle("darkT");
// }
  return (
    <div className={contentContainername}>
      ...
      >
        <Text>
          ...
          pvt. ltd.
          <Box as="b" className={styles.version} color="rgb(43, 57, 84)" px={1}>
            v1.0
          </Box>
        </Text>
      </Box>
